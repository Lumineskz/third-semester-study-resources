 ...
 *              and mixed arrays. It also introduces some useful
 *              array functions.
 ***************************************************************/
...
/* ===========================
   4. Arrays with Different Key Types
   =========================== */
echo "<h2>Arrays with Mixed Keys</h2>";

// String keys
$vegetables['carrot'] = 'red';
$vegetables['potato'] = 'yellow';
...
// Mixed data types inside an array
$test = ['volvo', 1, 234, true, 'test'];
print_r($test);
echo "<br>";
?>
